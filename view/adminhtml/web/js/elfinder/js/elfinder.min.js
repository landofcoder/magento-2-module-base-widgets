...
(function (a) {
    (window.elFinder = function (b, c) {
                    ...
                    (a.each(u, function (a, f) {
                        f.type == b.type &&
                            ...
                            (b.preventDefault(),
                                b.stopPropagation(),
                                f.callback(b, d),
                                d.debug("shortcut-exec", a + " : " + f.description));
                    }),
        ...
        (this.api = null),
            ...
            c.uiOptions &&
            c.uiOptions.toolbar &&
            (this.options.uiOptions.toolbar = c.uiOptions.toolbar),
            a.extend(this.options.contextmenu, c.contextmenu),
            (this.requestType = /^(get|post)$/i.test(this.options.requestType)
                ? this.options.requestType.toLowerCase()
                : "get"),
            (this.customData = a.isPlainObject(this.options.customData)
            ...
            (this.namespace = h),
            (this.lang =
                this.i18[this.options.lang] && this.i18[this.options.lang].messages
                    ? this.options.lang
                    : "en"),
            (I =
                this.lang == "en"
                    ? this.i18.en
                    : a.extend(!0, {}, this.i18.en, this.i18[this.lang])),
            ...
            (this.today =
                new Date(G.getFullYear(), G.getMonth(), G.getDate()).getTime() / 1e3),
            ...
            (this.cssClass =
                "ui-helper-reset ui-helper-clearfix ui-widget ui-widget-content ui-corner-all elfinder elfinder-" +
            ...
            (this.draggable = {
                ...
                helper: function (b, c) {
                    var e = this.id ? a(this) : a(this).parents("[id]:first"),
                        f = a(
                            '<div class="elfinder-drag-helper"><span class="elfinder-drag-helper-icon-plus"/></div>'
                        ),
                        g = function (a) {
                            return (
                        ...
                        i;
                    return (
                        d.trigger("dragstart", { target: e[0], originalEvent: b }),
                        (h = e.is("." + d.res("class", "cwdfile"))
                            ? d.selected()
                            : [d.navId2Hash(e.attr("id"))]),
                        f.append(g(r[h[0]].mime)).data("files", h),
                        (i = h.length) > 1 &&
                        f.append(
                            g(r[h[i - 1]].mime) +
                            '<span class="elfinder-drag-num">' +
                            i +
                            "</span>"
                        ),
                        f
            ...
            (this.droppable = {
                ...
                tolerance: "pointer",
                accept:
                    ".elfinder-cwd-file-wrapper,.elfinder-navbar-dir,.elfinder-cwd-file,.elfinder-cwd-filename",
                ...
                drop: function (b, c) {
                    ...
                    e.is("." + d.res(h, "cwd"))
                        ? (j = p)
                        : e.is("." + d.res(h, "cwdfile"))
                            ? (j = e.attr("id"))
                            : e.is("." + d.res(h, "navdir")) &&
                            (j = d.navId2Hash(e.attr("id"))),
                        (i = f.length);
                    while (i--) (l = f[i]), l != j && r[l].phash != j && g.push(l);
                    g.length &&
                        (c.helper.hide(),
                            d.clipboard(g, !(b.ctrlKey || b.shiftKey || b.metaKey)),
                            d.exec("paste", j).always(function () {
                                d.clipboard([]);
                            }),
            ...
            (this.path = function (a) {
                return r[a] && r[a].path
                    ? r[a].path
                    : this.path2array(a).join(q.separator);
            }),
            (this.url = function (b) {
                var c = r[b];
                if (!c || !c.read) return "";
                ...
                if (q.url)
                    return (
                        q.url +
                        a
                            .map(this.path2array(b), function (a) {
                ...
                return (
                    this.oldAPI && ((d.cmd = "open"), (d.current = c.phash)),
                    this.options.url +
            ...
            (this.tmb = function (b) {
                ...
                return (
                    d &&
                    (a.browser.opera || a.browser.msie) &&
            ...
            (this.request = function (b) {
                var c = this,
                    d = this.options,
                    e = a.Deferred(),
                    f = a.extend({}, d.customData, { mimes: d.onlyMimes }, b.data || b),
                    g = f.cmd,
                    ...
                    o = function (a, b) {
                        ...
                        switch (b) {
                            ...
                            default:
                                a.status == 403
                                    ? (c = ["errConnect", "errAccess"])
                                    : a.status == 404
                                        ? (c = ["errConnect", "errNotFound"])
                                        : (c = "errConnect");
                        }
                        e.reject(c, a, b);
                    },
            ...
            (this.sync = function () {
                ...
                return (
                    a
                        .when(this.request(d), this.request(e))
                        .fail(function (a) {
                            c.reject(a),
                                a &&
                                b.request({
            ...
            (this.shortcut = function (b) {
                var c, d, e, f, g;
                if (
                    this.options.allowShortcuts &&
                    b.pattern &&
                    a.isFunction(b.callback)
                ) {
            ...
            (this.clipboard = function (b, c) {
                ...
                return (
                    b !== void 0 &&
                    (v.length && this.trigger("unlockfiles", { files: d() }),
                        (w = []),
                        (v = a.map(b || [], function (a) {
                            var b = r[a];
                            return b
                                ? (w.push(a),
                                {
                        ...
                        c && this.trigger("lockfiles", { files: d() })),
                    v.slice(0, v.length)
                );
            }),
            ...
            (this.exec = function (b, c, d) {
                return this._commands[b] && this.isCommandEnabled(b)
                    ? this._commands[b].exec(c, d)
                    : a.Deferred().reject("No such command");
            }),
            ...
            (this.resize = function (a, c) {
                b.css("width", a).height(c).trigger("resize"),
                    this.trigger("resize", { width: b.width(), height: b.height() });
            }),
            ...
            (this.destroy = function () {
                b &&
                    ...
                    (this.trigger("destroy").disable(),
                        ...
                        (d.trigger = function () { }),
                        b.children().remove(),
                        b.append(e.contents()).removeClass(this.cssClass).attr("style", f),
                        (b[0].elfinder = null),
                        C && clearInterval(C));
            }),
        ...
        a.extend(a.ui.keyCode, {
            ...
            ((this.transport = this.options.transport),
                typeof this.transport.init == "function" && this.transport.init(this)),
            typeof this.transport.send != "function" &&
            (this.transport.send = function (b) {
                return a.ajax(b);
            }),
            this.transport.upload == "iframe"
                ? (this.transport.upload = a.proxy(this.uploads.iframe, this))
                : typeof this.transport.upload == "function"
                    ? (this.dragUpload = !!this.options.dragUploadAllow)
                    : this.xhrUpload
                        ? ((this.transport.upload = a.proxy(this.uploads.xhr, this)),
                            (this.dragUpload = !0))
                        : (this.transport.upload = a.proxy(this.uploads.iframe, this)),
            (this.error = function () {
                var a = arguments[0];
                return arguments.length == 1 && typeof a == "function"
                    ? d.bind("error", a)
                    : d.trigger("error", { error: a });
            }),
            a.each(
                [
                    "enable",
                ...
                function (b, c) {
                    d[c] = function () {
                        var b = arguments[0];
                        return arguments.length == 1 && typeof b == "function"
                            ? d.bind(c, b)
                            : d.trigger(c, a.isPlainObject(b) ? b : {});
                    };
                }
            ),
            this.enable(function () {
                !l &&
                    d.visible() &&
                    d.ui.overlay.is(":hidden") &&
                    ((l = !0),
                        a("texarea:focus,input:focus,button").blur(),
                        b.removeClass("elfinder-disabled"));
            })
                .disable(function () {
            ...
            typeof this.options.getFileCallback == "function" &&
            this.commands.getfile &&
            (this.bind("dblclick", function (a) {
                a.preventDefault(),
            ...
            a.each(this.options.commands, function (b, c) {
                ...
                a.isFunction(e) &&
                    ...
                    ((e.prototype = y),
                        (d._commands[c] = new e()),
                        d._commands[c].setup(c, d.options.commandsOptions[c] || {}));
            }),
            ...
            (this.ui = {
                ...
                navbar: a("<div/>")
                    .appendTo(b)
                    .elfindernavbar(this, this.options.uiOptions.navbar || {}),
                ...
                statusbar: a(
                    '<div class="ui-widget-header ui-helper-clearfix ui-corner-bottom elfinder-statusbar"/>'
                )
                    .hide()
                    .appendTo(b),
            }),
        ...
        (elFinder.prototype = {
            ...
            rules: {
                defaults: function (b) {
                    return !b ||
                        (b.added && !a.isArray(b.added)) ||
                        (b.removed && !a.isArray(b.removed)) ||
                        (b.changed && !a.isArray(b.changed))
                        ? !1
                        : !0;
                },
                open: function (b) {
                ...
                tmb: function (b) {
                    return (
                        b && b.images && (a.isPlainObject(b.images) || a.isArray(b.images))
                    );
                },
                upload: function (b) {
            ...
            parseUploadData: function (b) {
                ...
                return this.validResponse("upload", c)
                    ? ((c = this.normalize(c)),
                        (c.removed = a.map(c.added || [], function (a) {
                            return a.hash;
                        })),
                        c)
                    : { error: ["errResponse"] };
                ...
                iframe: function (b, c) {
                    var d = c ? c : this,
                        ...
                        h = a(
                            ...
                            g +
                            '" style="display:none"><input type="hidden" name="cmd" value="upload" /></form>'
                        ),
                        i = a.browser.msie,
                        j = function () {
                            o && clearTimeout(o),
                                n && clearTimeout(n),
                                m && d.notify({ type: "upload", cnt: -l }),
                                setTimeout(function () {
                        ...
                        k = a(
                            '<iframe src="' +
                            (i ? "javascript:false;" : "about:blank") +
                            '" name="' +
                            g +
                        ...
                        n,
                        o;
                    return e && a(e).is(":file") && a(e).val()
                        ? (h.append(e),
                            (l = e.files ? e.files.length : 1),
                            h
                                .append(
                                    '<input type="hidden" name="' +
                                    (d.newAPI ? "target" : "current") +
                                    '" value="' +
                                    d.cwd().hash +
                                    '"/>'
                                )
                                .append('<input type="hidden" name="html" value="1"/>')
                                .append(a(e).attr("name", "upload[]")),
                            a.each(d.options.onlyMimes || [], function (a, b) {
                                h.append(
                                    '<input type="hidden" name="mimes[]" value="' + b + '"/>'
                                );
                            }),
                ...
                xhr: function (b, c) {
                    var d = c ? c : this,
                        e = a
                            ...
                            .always(function () {
                                m && clearTimeout(m),
                                    k && d.notify({ type: "upload", cnt: -i, progress: 100 * i });
                            }),
                        ...
                        f.upload.addEventListener(
                            ...
                            function (a) {
                                var b = j,
                                    c;
                                a.lengthComputable &&
                                    ((c = parseInt((a.loaded * 100) / a.total)),
                                        c > 0 && !m && (m = l()),
                                        c - b > 4 &&
                                        ((j = c),
                                            k &&
            ...
            cookie: function (b, c) {
                ...
                return (
                    (e = a.extend({}, this.options.cookie)),
                    c === null && ((c = ""), (e.expires = -1)),
                    typeof e.expires == "number" &&
                    ((d = new Date()),
                        d.setTime(d.getTime() + e.expires * 864e5),
                        (e.expires = d)),
                    (document.cookie =
                        b +
                        "=" +
            ...
            normalize: function (b) {
                var c = function (a) {
                    return a && a.hash && a.name && a.mime
                        ? (a.mime == "application/x-empty" && (a.mime = "text/plain"), a)
                        : null;
                };
                return (
                    b.files && (b.files = a.map(b.files, c)),
            ...
            notify: function (b) {
                ...
                return c
                    ? (f.length ||
                        ((f = a(g.replace(/\{type\}/g, c).replace(/\{msg\}/g, d))
                            .appendTo(e)
                            .data("cnt", 0)),
                            i && f.data({ progress: 0, total: 0 })),
                        (j = h + parseInt(f.data("cnt"))),
                        j > 0
                            ? (!b.hideCnt &&
                                f.children(".elfinder-notify-cnt").text("(" + j + ")"),
                                e.is(":hidden") && e.elfinderdialog("open"),
                                f.data("cnt", j),
                                i < 100 &&
                                (k = f.data("total")) >= 0 &&
                                (l = f.data("progress")) >= 0 &&
                                ((k = h + parseInt(f.data("total"))),
                                    (l = i + l),
                                    (i = parseInt(l / k)),
                                    f.data({ progress: l, total: k }),
                                    e
                                        .find(".elfinder-notify-progress")
                                        .animate({ width: (i < 100 ? i : 100) + "%" }, 20)))
                            : (f.remove(), !e.children().length && e.elfinderdialog("close")),
                        this)
                    : this;
            },
            confirm: function (b) {
                ...
                return (
                    b.reject &&
                    (d.buttons[this.i18n(b.reject.label)] = function () {
                    ...
                    b.all &&
                    (b.reject && (d.width = 370),
                        (d.create = function () {
                            (g = a('<input type="checkbox" />')),
                                a(this)
                                    .next()
                                    .children()
                                    .before(a("<label>" + e + "</label>").prepend(g));
                        }),
                        (d.open = function () {
                            var b = a(this).next(),
                                c = parseInt(
                                    b.children(":first").outerWidth() +
                                    b.children(":last").outerWidth()
                                );
                            c > parseInt(b.width()) &&
                                a(this)
                                    .closest(".elfinder-dialog")
                                    .width(c + 30);
                        })),
                    this.dialog(
                ...
                for (g = 0; g < d.length; g++) {
                    ...
                    (i = d[g]),
                        ...
                        (i = i.replace(/\$(\d+)/g, function (a, b) {
                            return (
                                (b = g + parseInt(b)), b > 0 && d[b] && e.push(b), d[b] || ""
                            );
                        })),
                        (d[g] = i);
                }
            ...
            formatDate: function (a, b) {
                var c = this,
                    ...
                    n,
                    o;
                return c.options.clientFormatDate && b > 0
                    ? ((e = new Date(b * 1e3)),
                        (l = e[c.getHours]()),
                        (m = l > 12 ? l - 12 : l),
                        (n = e[c.getMinutes]()),
                        ...
                        (j = e[c.getMonth]() + 1),
                        (k = e[c.getFullYear]()),
                        (f = b >= this.yesterday ? this.fancyFormat : this.dateFormat),
                        (g = f.replace(/[a-z]/gi, function (a) {
                            switch (a) {
                                case "d":
                                    return h > 9 ? h : "0" + h;
                                case "j":
                        ...
                        b >= this.yesterday
                            ? g.replace(
                                "$1",
                                this.i18n(b >= this.today ? "Today" : "Yesterday")
                            )
                            : g)
                    : a.date
                        ? a.date.replace(/([a-z]+)\s/i, function (a, b) {
                            return c.i18n(b) + " ";
                        })
                        : c.i18n("dateUnknown");
            },
            ...
            formatPermissions: function (a) {
                var b = [];
                return (
                    a.read && b.push(this.i18n("read")),
                    a.write && b.push(this.i18n("write")),
                    b.length
                        ? b.join(" " + this.i18n("and") + " ")
                        : this.i18n("noaccess")
                );
            },
            ...
            debug: function (b, c) {
                ...
                return (
                    (d == "all" || d === !0 || (a.isArray(d) && a.inArray(b, d) != -1)) &&
                    window.console &&
                    window.console.log &&
                    window.console.log(
                        "elfinder debug: [" + b + "] [" + this.id + "]",
                        c
                    ),
                    this
                );
        ...
        (elFinder.prototype.history = function (b) {
            var c = this,
                ...
                h = function (h) {
                    return (h && c.canForward()) || (!h && c.canBack())
                        ? ((d = !1), b.exec("open", e[h ? ++f : --f]).fail(g))
                        : a.Deferred().reject();
                };
            ...
            (this.fm = b),
                ...
                (this._handlers = {
                    ...
                    "open reload load": function (a) {
                        (this._disabled =
                            !this.alwaysEnabled && !this.fm.isCommandEnabled(this.name)),
                            this.update(void 0, this.value),
                            this.change();
                    },
                }),
                ...
                (this.setup = function (b, c) {
                    ...
                    this.disableOnSearch &&
                        e.bind("search searchend", function (a) {
                ...
                (this.update = function (a, b) {
                    ...
                    this._disabled
                        ? (this.state = -1)
                        : (this.state = a !== void 0 ? a : this.getstate()),
                        (this.value = b),
                ...
                (this.hashes = function (c) {
                    return c
                        ? a.map(a.isArray(c) ? c : [c], function (a) {
                ...
                (this.files = function (b) {
                    var c = this.fm;
                    return b
                        ? a.map(a.isArray(b) ? b : [b], function (a) {
        ...
        (elFinder.prototype.resources = {
            ...
            mixin: {
                make: function () {
                            ...
                            .keydown(function (b) {
                                b.stopImmediatePropagation(),
                                    b.keyCode == a.ui.keyCode.ESCAPE
                                        ? e.reject()
                                        : b.keyCode == a.ui.keyCode.ENTER && k.blur();
                            })
                    ...
                    return this.disabled() || !j.length
                        ? e.reject()
                        : (b.disable(),
                            j.find(".elfinder-cwd-filename").empty("").append(k.val(i.name)),
                            k.select().focus(),
                            e);
                },
            },
        ...
        (a.fn.dialogelfinder = function (b) {
            ...
            this.not(".elfinder").each(function () {
                var e = a(document),
                    f = a(
                        '<div class="ui-widget-header dialogelfinder-drag ui-corner-top">' +
                        (b.title || "Files") +
                        "</div>"
                    ),
                    g = a(
                        '<a href="#" class="dialogelfinder-drag-close ui-corner-all"><span class="ui-icon ui-icon-closethick"/></a>'
                    )
                        .appendTo(f)
                        .click(function (a) {
                ...
                h
                    .width(parseInt(h.width()) || 840)
                    .data(d, !!b.destroyOnClose)
            ...
            if (b == "open") {
                var e = a(this),
                    f = e.data(c) || {
                        top: parseInt(
                            ...
                            (a(window).height() < e.height()
                                ? 2
                                : (a(window).height() - e.height()) / 2)
                        ),
                        left: parseInt(
                            a(document).scrollLeft() +
                            (a(window).width() < e.width()
                                ? 2
                                : (a(window).width() - e.width()) / 2)
                        ),
                    },
                    g = 100;
                e.is(":hidden") &&
                    (a("body")
                        ...
                        .each(function () {
                            ...
                            this !== e[0] &&
                                ...
                                (c = parseInt(b.zIndex())) > g &&
                                (g = c + 1);
                        }),
                        e.zIndex(g).css(f).show().trigger("resize"),
                        setTimeout(function () {
                ...
                var e = a(this);
                e.is(":visible") &&
                    (e.data(d) ? e.elfinder("destroy").remove() : e.elfinder("close"));
            ...
            return this.each(function () {
                var c = "class",
                    ...
                    k = a(this)
                        ...
                        .hover(function (a) {
                            !k.is("." + e) &&
                                k[a.type == "mouseleave" ? "removeClass" : "addClass"](g);
                        })
                        .click(function (a) {
                            k.is("." + e) ||
                                (j && b.variants.length > 1
                                    ? (j.is(":hidden") && b.fm.getUI().click(),
                                        a.stopPropagation(),
                                        j.slideToggle(100))
                                    : b.exec());
                        }),
                ...
                a.isArray(b.variants) &&
                    (k.addClass("elfinder-menubutton"),
                        (j = a(
                            '<div class="ui-widget ui-widget-content elfinder-button-menu ui-corner-all"/>'
                        )
                            .hide()
                            .appendTo(k)
                            .zIndex(10 + k.zIndex())
                            .delegate("." + h, "hover", function () {
                        ...
                        b.fm.bind("disable select", l).getUI().click(l),
                        b.change(function () {
                            j.html(""),
                                a.each(b.variants, function (c, d) {
                                    j.append(
                                        a('<div class="' + h + '">' + d[1] + "</div>")
                                            .data("value", d[0])
                                            .addClass(d[0] == b.value ? i : "")
                                    );
                                });
                        })),
                    b
                        .change(function () {
                            b.disabled()
                                ? k.removeClass(f + " " + g).addClass(e)
                                : (k.removeClass(e),
                                    k[b.active() ? "addClass" : "removeClass"](f));
                        })
                        .change();
            });
        }),
        (a.fn.elfindercontextmenu = function (b) {
            return this.each(function () {
                var c = a(this)
                    .addClass(
                        "ui-helper-reset ui-widget ui-state-default ui-corner-all elfinder-contextmenu elfinder-contextmenu-" + b.direction
                    )
                    .hide()
                    .appendTo("body")
                    ...
                    f =
                        '<div class="elfinder-contextmenu-item"><span class="elfinder-button-icon {icon} elfinder-contextmenu-icon"/><span style="margin-left: 25px;">{label}</span></div>',
                    g = function (b, c, d) {
                        return a(
                            f
                                .replace("{icon}", c ? "elfinder-button-icon-" + c : "")
                                .replace("{label}", b)
                        ).click(function (a) {
                            ...
                            if (j && j.getstate(f) != -1) {
                                if (j.variants) {
                                    ...
                                    (k = g(j.title, j.name, function () { })),
                                        (l = a(
                                            '<div class="ui-corner-all elfinder-contextmenu-sub"/>'
                                        ).appendTo(
                                            k.append('<span class="elfinder-contextmenu-arrow"/>')
                                        )),
                                        ...
                                        a.each(j.variants, function (b, c) {
                                            l.append(
                                                a(
                                                    '<div class="elfinder-contextmenu-item"><span>' +
                                                    c[1] +
                                                    "</span></div>"
                                                ).click(function (a) {
                    ...
                    var c = b.storage("view") == "list",
                        ...
                        u = {
                            icon:
                                '<div id="{hash}" class="' +
                                j +
                                ' {permsclass} {dirclass} ui-corner-all" title="{tooltip}"><div class="elfinder-cwd-file-wrapper ui-corner-all"><div class="elfinder-cwd-icon {mime} ui-corner-all" unselectable="on"{style}></div>{marker}</div><div class="elfinder-cwd-filename" title="{nametitle}">{name}</div></div></div>',
                            row: "",
                        },
                        v = b.res("tpl", "perms"),
                        w = b.res("tpl", "symlink"),
                        x = {
                            ...
                            marker: function (a) {
                                return (
                                    (a.alias || a.mime == "symlink-broken" ? w : "") +
                                    (!a.read || !a.write ? v : "")
                                );
                            },
                        },
                        ...
                        A = function (b, d) {
                            ...
                            if (i.length) {
                                ...
                                if (!o.length) n = k;
                                    ...
                                    if (h) {
                                        ...
                                        while (
                                            n.length &&
                                            !(n.position().top < p && n.position().left <= q)
                                        );
                                        n.is("." + m) && (n = r(n, "next"));
                                    } else {
                                        do n = n.next("[id]");
                                        ...
                                        n.is("." + m) && (n = r(n, "prev")),
                                            n.length ||
                                            ((o = S.find("[id]:not(." + m + "):last")),
                                                o.position().top > p && (n = o));
                                    }
                                }
                            } else
                            ...
                            n &&
                                ...
                                (d
                                    ? (n = k
                                        .add(k[h ? "prevUntil" : "nextUntil"]("#" + n.attr("id")))
                                        .add(n))
                                    : i.trigger(f),
                                    n.trigger(e),
                                    F(n.filter(h ? ":first" : ":last")),
                                    E());
                        },
                        B = function (a) {
                            S.find("#" + a).trigger(e);
                        ...
                        J = function () {
                            ...
                            while (
                                (!h.length ||
                                    h.position().top <=
                                    T.height() + T.scrollTop() + b.options.showThreshold) &&
                                (k = G.splice(0, b.options.showFiles)).length
                            )
                                (d = a.map(k, function (a) {
                                    return a.hash && a.name
                                        ? (a.mime == "directory" && (e = !0),
                                            a.tmb &&
                                            (a.tmb === 1 ? f.push(a.hash) : (g[a.hash] = a.tmb)),
                                            y(a))
                                        : null;
                                })),
                                    j.append(d.join("")),
                        ...
                        L = function () {
                            setTimeout(function () {
                                S.find(
                                    ".directory:not(." + o + ",.elfinder-na,.elfinder-ro)"
                                ...
                                a.each(c, function (b, c) {
                                    ...
                                    g.length
                                        ? (function (b, c) {
                                            a("<img/>")
                                                .load(function () {
                                                    b.find(".elfinder-cwd-icon").css(
                                                        "background",
                                                        "url('" + c + "') center center no-repeat"
                                                    );
                                                })
                                                .attr("src", c);
                                        })(g, d + c)
                                        : ((e = !1), (f = H(b)) != -1 && (G[f].tmb = c));
                                }),
                                e
                            );
                        },
                        N = function (a) {
                            ...
                            if (b.oldAPI) {
                                b.request({
                                    data: { cmd: "tmb", current: b.cwd().hash },
                                    preventFail: !0,
                                }).done(function (a) {
                                    M(a.images || []) && a.tmb && N();
                                });
                        ...
                        O = function (a) {
                            ...
                            while (e--) {
                                ...
                                (m = i(k)) && m.length
                                    ...
                                    (k.mime == "directory"
                                        ? (h = !0)
                                        : k.tmb && (k.tmb === 1 ? f.push(l) : (g[l] = k.tmb)));
                            }
                        ...
                        R = function (d, e) {
                            ...
                            S.removeClass(
                                "elfinder-cwd-view-icons elfinder-cwd-view-list"
                            ).addClass("elfinder-cwd-view-" + (c ? "list" : "icons")).attr("style", "").css("height", "auto"),
                                T[c ? "addClass" : "removeClass"]("elfinder-cwd-wrapper-list"),
                                c &&
                                S.html(
                                    '<table><thead><tr class="ui-state-default"><td >' +
                                    Q.name +
                                    "</td><td>" +
                                    Q.perm +
                                    "</td><td>" +
                        ...
                        S = a(this)
                            ...
                            .on(k, "click." + b.namespace, function (b) {
                                ...
                                b.stopImmediatePropagation(),
                                    b.shiftKey && (h || i)
                                        ? ((j = h
                                            ? c.prevUntil("#" + d.attr("id"))
                                            : c.nextUntil("#" + g.attr("id"))),
                                            j.add(c).trigger(e))
                                        : b.ctrlKey || b.metaKey
                                            ? c.trigger(c.is("." + l) ? f : e)
                                            : (S.find("[id]." + l).trigger(f), c.trigger(e)),
                                    E();
                            })
                            ...
                            .bind("contextmenu." + b.namespace, function (c) {
                                ...
                                d.length &&
                                    (c.stopPropagation(),
                                        ...
                                        d.is("." + m) ||
                                        (d.is("." + l) ||
                                            (S.trigger("unselectall"), d.trigger(e), E()),
                            ...
                            .droppable(K)
                            .bind("create." + b.namespace, function (b, d) {
                        ...
                        T = a('<div class="elfinder-cwd-wrapper"></div>').bind(
                            "contextmenu",
                            function (a) {
                                a.preventDefault(),
                                    b.trigger("contextmenu", {
                        ...
                        U = function () {
                            if ("undefined" != typeof s.renderd) {
                                var b = 0;
                                T.siblings("div.elfinder-panel:visible").each(function () {
                                    b += a(this).outerHeight(!0);
                                }),
                                    T.height(W.height() - b - T._padding);
                            }
                        },
                            ...
                            T[0].addEventListener(
                                ...
                                function (a) {
                                    a.preventDefault(),
                                        ...
                                        b.exec("upload", { files: a.dataTransfer.files });
                                },
                                !1
                            )),
                        b
                            .bind("open search", function (a) {
                            ...
                            .change(function (c) {
                                var d = b.cwd().hash,
                                    ...
                                    f;
                                t
                                    ? a.each(c.data.changed || [], function (b, c) {
                                        P([c.hash]),
                                            c.name.indexOf(t) !== -1 &&
                                            (O([c]), a.inArray(c.hash, e) !== -1 && B(c.hash));
                                    })
                                    : a.each(
                                        a.map(c.data.changed || [], function (a) {
                                            return a.phash == d ? a : null;
                                        }),
                                        function (b, c) {
                                            P([c.hash]),
                            ...
                            .bind("open add search searchend", function () {
                                S.css("height", "auto"),
                                    S.outerHeight(!0) < T.height() &&
                                    S.height(T.height() - (S.outerHeight(!0) - S.height()) - 2);
                            })
                            ...
                            .bind(
                                "mkdir mkfile duplicate upload rename archive extract",
                                function (c) {
                                    var d = b.cwd().hash,
                                        e;
                                    S.trigger("unselectall"),
        ...
        (a.fn.elfinderdialog = function (b) {
            ...
            return (
                typeof b == "string" &&
                (c = this.closest(".ui-dialog")).length &&
                (b == "open" && c.is(":hidden")
                    ? c.fadeIn(120, function () {
                        c.trigger("open");
                    })
                    : b == "close" && c.is(":visible")
                        ? c.hide().trigger("close")
                        : b == "destroy"
                            ? c.hide().remove()
                            : b == "toTop" && c.trigger("totop")),
                ...
                this.filter(":not(.ui-dialog-content)").each(function () {
                    var c = a(this).addClass("ui-dialog-content ui-widget-content"),
                        ...
                        m = a(
                            '<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable std42-dialog  ' +
                            f +
                            " " +
                            b.cssClass +
                            '"/>'
                            ...
                            .mousedown(function (b) {
                                b.stopPropagation(),
                                    ...
                                    m.is("." + e) ||
                                    (d.find("." + f + ":visible").removeClass(e),
                                        m.addClass(e).zIndex(n() + 1));
                            })
                            .bind("open", function () {
                                b.modal && j.elfinderoverlay("show"),
                                    ...
                                    d
                                        ...
                                        .each(function () {
                                            ...
                                            b[0] != m[0] &&
                                                (c == e || d == f) &&
                                                m.css({ top: c + 10 + "px", left: d + 10 + "px" });
                                        });
                            })
                            .bind("close", function () {
                                ...
                                b.modal && j.elfinderoverlay("hide"),
                                    ...
                                    typeof b.close == "function"
                                        ? a.proxy(b.close, c[0])()
                                        : b.destroyOnClose && m.hide().remove();
                            })
                            .bind("totop", function () {
                                a(this)
                                    .mousedown()
                        ...
                        n = function () {
                            var b = d.zIndex() + 10;
                            return (
                                d.find("." + f + ":visible").each(function () {
                                    var c;
                        ...
                        o;
                    b.position ||
                        ((o = parseInt((d.height() - m.outerHeight()) / 2 - 42)),
                            (b.position = {
                                top: (o > 0 ? o : 0) + "px",
                        ...
                        m.css(b.position),
                        b.closeOnEscape &&
                        a(document).bind("keyup." + i, function (b) {
                            b.keyCode == a.ui.keyCode.ESCAPE &&
                                m.is("." + e) &&
                                (c.elfinderdialog("close"), a(document).unbind("keyup." + i));
                        }),
                        m.prepend(
                            a(
                                ...
                                a(
                                    '<a href="#" class="ui-dialog-titlebar-close ui-corner-all"><span class="ui-icon ui-icon-closethick"/></a>'
                                ).mousedown(function (a) {
                        ...
                        a.each(b.buttons, function (b, d) {
                            var e = a(
                                '<button type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"><span class="ui-button-text">' +
                                b +
                                "</span></button>"
                            )
                                .click(a.proxy(d, c[0]))
                                ...
                                .keydown(function (b) {
                                    ...
                                    b.keyCode == a.ui.keyCode.ENTER
                                        ? a(this).click()
                                        : b.keyCode == a.ui.keyCode.TAB &&
                                        ((c = a(this).next(".ui-button")),
                                            c.length
                                                ? c.focus()
                                                : a(this)
                                                    .parent()
                        ...
                        ((i = d
                            ...
                            .bind("resize scroll", function () {
                                i.css({
                                    ...
                                    left: parseInt(
                                        h
                                            ? d.width() + d.scrollLeft() - i.width() - 2
                                            : d.scrollLeft() + 2
                                    ),
                                });
                            })
        ...
        (a.fn.elfinderoverlay = function (b) {
            this.filter(":not(.elfinder-overlay)").each(function () {
                (b = a.extend({}, b)),
                    a(this)
                        .addClass("ui-widget-overlay elfinder-overlay")
                        .hide()
                        .mousedown(function (a) {
                            a.preventDefault(), a.stopPropagation();
                        })
        ...
        (a.fn.elfinderpanel = function (b) {
            return this.each(function () {
                var c = a(this).addClass(
                    "elfinder-panel ui-state-default ui-corner-all"
                ),
        ...
        (a.fn.elfinderpath = function (b) {
            return this.each(function () {
                var c = a(this)
                    .addClass("elfinder-path")
                    .html("&nbsp;")
                    .delegate("a", "click", function (c) {
                ...
                var d = [],
                    ...
                    q = function (c) {
                        return a(
                            k
                                .replace(/\{id\}/, o(c.hash))
                                .replace(/\{name\}/, b.escape(c.name))
                                .replace(/\{cssclass\}/, b.perms2class(c))
                                .replace(/\{permissions\}/, !c.read || !c.write ? l : "")
                                .replace(/\{symlink\}/, "")
                        );
                    },
                    r = function (c) {
                        ...
                        w.children().length &&
                            ...
                            e.draggable({
                                ...
                                helper: function () {
                                    var c = a(this);
                                    return (
                                        c.children().removeClass("ui-state-hover"),
                                        a(
                                            '<div class="elfinder-place-drag elfinder-' +
                                            b.direction +
                                            '"/>'
                                        )
                                            .append(c.clone())
                                            .data("hash", n(c.children(":first").attr("id")))
                                    );
                                },
                                start: function () {
                                    a(this).hide();
                        ...
                        c !== -1 &&
                            (d.splice(c, 1),
                                w
                                    ...
                                    .parent()
                                    .remove(),
                                !w.children().length && v.removeClass(g + " " + h));
                    },
                    t = function () {
                    ...
                    v = u
                        ...
                        .click(function () {
                            v.is("." + g) &&
                                (x.toggleClass(h),
                                    w.slideToggle(),
                                    b.storage("placesState", x.is("." + h) ? 1 : 0));
                        }),
                    w = u.children("." + b.res(e, "navsubtree")),
                    x = a(this)
                        .addClass(b.res(e, "tree") + " elfinder-places ui-corner-all")
                        .hide()
                        .append(u)
                        .appendTo(b.getUI("navbar"))
                        .delegate("." + f, "hover", function () {
                            a(this).toggleClass("ui-state-hover");
                        })
                        ...
                        .droppable({
                            tolerance: "pointer",
                            accept:
                                ".elfinder-cwd-file-wrapper,.elfinder-tree-dir,.elfinder-cwd-file",
                            ...
                            drop: function (c, e) {
                                ...
                                a.each(e.helper.data("files"), function (c, e) {
                                    var g = b.file(e);
                                    g && g.mime == "directory" && a.inArray(g.hash, d) === -1
                                        ? r(g)
                                        : (f = !1);
                                }),
                                    p(),
                ...
                b.one("load", function () {
                    ...
                    x.show().parent().show(),
                        ...
                        b
                            ...
                            .change(function (b) {
                                a.each(b.data.changed, function (b, c) {
                                    a.inArray(c.hash, d) !== -1 &&
                                        (s(c.hash), c.mime == "directory" && r(c));
                                }),
                                    p();
                            })
                            .bind("sync", function () {
            ...
            return this.each(function () {
                var c = !1,
                    d = a(this)
                        .hide()
                        .addClass(
                            "ui-widget-content elfinder-button " +
                            b.fm.res("class", "searchbtn") +
                            ""
                        ),
                    e = function () {
                ...
                a('<span class="ui-icon ui-icon-search" title="' + b.title + '"/>')
                    .appendTo(d)
                    .click(e),
                    ...
                    setTimeout(function () {
                        ...
                        if (a.browser.msie) {
                            var c = d.children(
                                b.fm.direction == "ltr" ? ".ui-icon-close" : ".ui-icon-search"
                            );
                            c.css({
                                right: "",
        ...
        (a.fn.elfindersortbutton = function (b) {
            return this.each(function () {
                var c = "class",
                    ...
                    k = a(this)
                        .addClass(
                            "ui-state-default elfinder-button elfiner-button-" + b.name
                        )
                        .attr("title", b.title)
                        .append(
                            '<span class="elfinder-button-icon elfinder-button-icon-' +
                                ...
                                a.each(b.variants, function (c, d) {
                                    j.append(
                                        a(
                                            ...
                                            " " +
                                            (d[0] == b.value ? i : "") +
                                            " elfinder-menu-item-sort-" +
                                            b.fm.sortDirect +
                                            '"><span class="elfinder-menu-item-sort-dir"/>' +
                                            d[1] +
                                            "</div>"
                                        ).data("value", d[0])
                                    );
                    ...
                    b
                        ...
                        .select(function () {
                            ...
                            if (h.length == 1) {
                                (c = h[0].size),
                                    d.html(
                                        b.escape(h[0].name) + (c > 0 ? ", " + b.formatSize(c) : "")
                                    );
                                return;
                            }
                            a.each(h, function (a, b) {
                    ...
                    var e = "class",
                        ...
                        D = function (a) {
                            ...
                            for (e = 0; e < c; e++) {
                                ...
                                (h = B(f.phash)).length
                                    ? ((g = z(f)),
                                        f.phash && (i = C(h, f)).length ? i.before(g) : h.append(g))
                                    : d.push(f);
                            }
                        ...
                        E = function () {
                            ...
                            g &&
                                ((e = H.find("#" + b.navHash2Id(b.root()))),
                                    ...
                                    (g = !1)),
                                d.is("." + n) ||
                                (H.find("." + i + "." + n).removeClass(n), d.addClass(n)),
                                c.syncTree &&
                                (d.length
                                    ? d
                                        .parentsUntil("." + f)
                        ...
                        F = function () {
                            H.find(
                                "." + i + ":not(." + s + ",.elfinder-ro,.elfinder-na)"
                            ).droppable(t);
                        },
                        G = function (c, d) {
                            var e =
                        ...
                        H = a(this)
                            .addClass(d)
                            .delegate("." + i, "hover", function (c) {
                                var d = a(this),
                                    e = c.type == "mouseenter";
                                d.is("." + o + " ,." + q) ||
                                    (e &&
                                        !d.is("." + f + ",." + r + ",.elfinder-na,.elfinder-wo") &&
                                        d.draggable(b.draggable),
                                        d.toggleClass(p, e));
                            })
                            .delegate("." + i, "dropover dropout drop", function (b) {
                                a(this)[b.type == "dropover" ? "addClass" : "removeClass"](
                                    o + " " + p
                                );
                            })
                            .delegate("." + i, "click", function (c) {
                                ...
                                b.trigger("searchend"),
                                    e != b.cwd().hash && !d.is("." + q)
                                        ? b.exec("open", f.thash || e)
                                        : d.is("." + j) && d.children("." + m).click();
                            })
                        ...
                        b
                                ...
                                while (e--) {
                                    ...
                                    if ((g = H.find("#" + b.navHash2Id(f.hash))).length) {
                                        ...
                                        (q = g.is("." + k)),
                                            ...
                                            f.dirs &&
                                            (q || r) &&
                                            (g = H.find("#" + b.navHash2Id(f.hash))) &&
                                            g.next("." + h).children().length &&
                                            (q && g.addClass(k), r && g.addClass(l));
                                    }
                                }
                                E(), F();
                            })
                            .remove(function (a) {
                                var c = a.data.removed,
                                    ...
                                    f;
                                while (d--)
                                    (e = H.find("#" + b.navHash2Id(c[d]))).length &&
                                        ((f = e.closest("." + h)),
                                            e.parent().detach(),
                                            f.children().length ||
                                            f
                            ...
                            .bind("search searchend", function (a) {
                                H.find("#" + b.navHash2Id(b.cwd().hash))[
                                    a.type == "search" ? "removeClass" : "addClass"
                                ](n);
                            })
                            .bind("lockfiles unlockfiles", function (c) {
                                ...
                                a.each(f, function (a, c) {
                                    ...
                                    f.length &&
                                        (f.is("." + r) && f.draggable(e),
                                            f.is("." + s) && f.droppable(n),
                                            f[d ? "addClass" : "removeClass"](q));
                                });
                            });
                }),
                this
            ...
            return this.each(function () {
                var c = a(this).elfinderbutton(b).unbind("click"),
                    ...
                    e = a('<input type="file" multiple="true"/>').change(function () {
                        var c = a(this);
                        c.val() &&
                            (b.exec({ input: c.remove()[0] }), e.clone(!0).appendTo(d));
                    });
                d.append(e.clone(!0)),
                    b
                        .change(function () {
        ...
        (elFinder.prototype.commands.copy = function () {
            (this.shortcuts = [{ pattern: "ctrl+c ctrl+insert" }]),
                ...
                (this.exec = function (b) {
                    ...
                    return (
                        a.each(this.files(b), function (a, b) {
                            if (!b.read || !b.phash)
            ...
            (this.shortcuts = [{ pattern: "ctrl+x shift+insert" }]),
                ...
                (this.exec = function (b) {
                    ...
                    return (
                        ...
                        d.state() == "rejected"
                            ? d
                            : d.resolve(c.clipboard(this.hashes(b), !0))
                    );
                });
        }),
            ...
            var b = this,
                ...
                e = function (c) {
                    return a.map(c, function (c) {
                        return (c.mime.indexOf("text/") === 0 ||
                            a.inArray(c.mime, d) !== -1) &&
                            c.mime.indexOf("text/rtf") &&
                            (!b.onlyMimes.length || a.inArray(c.mime, b.onlyMimes) !== -1) &&
                            c.read &&
                            c.write
                            ? c
                            : null;
                            ...
                            if (
                                ...
                                return (
                                    (h.editor = {
                                        ...
                                        save: c.save,
                                        close:
                                            typeof c.close == "function" ? c.close : function () { },
                                        instance: null,
                                    }),
                                    !1
                                );
                            ...
                            a.stopPropagation(),
                                ...
                                (a.preventDefault(),
                                    ...
                                    ((c = this.value),
                                        ...
                                        (this.value =
                                            c.substr(0, d) + "	" + c.substr(this.selectionEnd)),
                                        (d += 1),
                ...
                g = function (b) {
                    var d = b.hash,
                        ...
                        l;
                    return k.length
                        ? (k.elfinderdialog("toTop"), g.resolve())
                        : !b.read || !b.write
                            ? ((l = ["errOpen", b.name, "errPerm"]), c.error(l), g.reject(l))
                            : (c
                                .request({
                                    data: { cmd: "get", target: d },
                ...
                (this.exec = function (b) {
                    ...
                    for (i = 0; i < g; i++) {
                        ...
                        if (!j.read || !c.file(j.phash).write)
                            return (
                                (k = ["errExtract", j.name, "errPerm"]), c.error(k), f.reject(k)
                            );
                        if (a.inArray(j.mime, d) === -1)
                            return (
                                (k = ["errExtract", j.name, "errNoArchive"]),
                                c.error(k),
                                f.reject(k)
                            );
                        c.request({
                ...
                (this.exec = function (c) {
                    var d = this.fm,
                        ...
                        j = a.Deferred().done(function (a) {
                            d.trigger("getfile", { files: a }),
                                b.callback(a, d),
                                e.oncomplete == "close"
                                    ? d.hide()
                                    : e.oncomplete == "destroy" && d.destroy();
                        }),
                        k = function (b) {
                            return e.onlyURL
                                ? e.multiple
                        ...
                        (n.baseUrl = h),
                            ...
                            (n.dim
                                ? ((o = n.dim.split("x")),
                                    (n.width = o[0]),
                                    (n.height = o[1]))
                                : n.mime.indexOf("image") !== -1 &&
                                l.push(
                                    d
                                        .request({
                                            data: { cmd: "dim", target: n.hash },
                                            preventDefault: !0,
                                        })
                                        .done(
                                            a.proxy(function (a) {
                    ...
                    return l.length
                        ? (a.when.apply(null, l).always(function () {
                            j.resolve(k(f));
                        }),
                            j)
                        : j.resolve(k(f));
        ...
        (elFinder.prototype.commands.help = function () {
            var b = this.fm,
                ...
                r = function () {
                    o.push(
                        '<div id="about" class="ui-tabs-panel ui-widget-content ui-corner-bottom"><div class="elfinder-help-logo"/>'
                    ),
                        ...
                        o.push(
                            d[j](f, "https://github.com/Studio-42/elFinder/wiki")[j](
                                g,
                                b.i18n("docs")
                            )
                        ),
                        o.push(
                            d[j](f, "https://github.com/Studio-42/elFinder")[j](
                                g,
                                b.i18n("github")
                            )
                        ),
                        o.push(
                            d[j](f, "http://twitter.com/elrte_elfinder")[j](
                                g,
                                b.i18n("twitter")
                            )
                        ),
                        ...
                        o.push(
                            e[j](h, 'Dmitry "dio" Levashov &lt;dio@std42.ru&gt;')[j](
                                i,
                                b.i18n("chiefdev")
                            )
                        ),
                        o.push(
                            e[j](h, "Troex Nevelin &lt;troex@fury.scancode.ru&gt;")[j](
                                i,
                                b.i18n("maintainer")
                            )
                        ),
                        o.push(
                            e[j](h, "Alexey Sukhotin &lt;strogg@yandex.ru&gt;")[j](
                                i,
                                b.i18n("contributor")
                            )
                        ),
                        o.push(
                            e[j](h, "Naoki Sawada &lt;hypweb@gmail.com&gt;")[j](
                                i,
                                b.i18n("contributor")
                            )
                        ),
                        b.i18[b.lang].translator &&
                        o.push(
                            e[j](h, b.i18[b.lang].translator)[j](
                                i,
                                b.i18n("translator") + " (" + b.i18[b.lang].language + ")"
                            )
                        ),
                        o.push(q),
                        o.push(
                            ...
                            '">' +
                            b.i18n("icons") +
                            ': <a href="http://pixelmixer.ru/" target="_blank">Pixelmixer</a>, <a href="http://p.yusukekamiyamane.com" target="_blank">Fugue</a></div>'
                        ),
                        o.push(q),
                        o.push('<div class="' + m + '">Licence: BSD Licence</div>'),
                        o.push(
                            '<div class="' + m + '">Copyright © 2009-2011, Studio 42</div>'
                        ),
                        o.push(
                            '<div class="' + m + '">„ …' + b.i18n("dontforget") + " ”</div>"
                        ),
                        o.push("</div>");
                },
                s = function () {
                    var c = b.shortcuts();
                    o.push(
                        '<div id="shortcuts" class="ui-tabs-panel ui-widget-content ui-corner-bottom">'
                    ),
                        c.length
                            ? (o.push(
                                '<div class="ui-widget-content elfinder-help-shortcuts">'
                            ),
                                a.each(c, function (a, b) {
                                    o.push(
                                        p.replace(/\{pattern\}/, b[0]).replace(/\{descrip\}/, b[1])
                                    );
                                }),
                                o.push("</div>"))
                            : o.push(
                                '<div class="elfinder-help-disabled">' +
                                b.i18n("shortcutsof") +
                                "</div>"
                            ),
                        o.push("</div>");
                ...
                t = function () {
                    o.push(
                        ...
                        o.push(
                            '<a href="http://elfinder.org/forum/" target="_blank" class="elfinder-dont-panic"><span>DON\'T PANIC</span></a>'
                        ),
                        o.push("</div>");
                },
                u;
        ...
        (elFinder.prototype.commands.info = function () {
            ...
            (this.tpl = {
                ...
                (this.exec = function (b) {
                    ...
                    j == 1
                        ? ((v = i[0]),
                            (l = l.replace("{class}", f.mime2class(v.mime))),
                            (w = g.itemTitle
                                .replace("{name}", v.name)
                                .replace("{kind}", f.mime2kind(v))),
                            v.tmb && (u = f.option("tmbUrl") + v.tmb),
                            v.read
                                ? v.mime != "directory" || v.alias
                                    ? (t = f.formatSize(v.size))
                                    : ((t = g.spinner.replace("{text}", e.calc)), p.push(v.hash))
                                : (t = e.unknown),
                            k.push(h.replace(m, e.size).replace(n, t)),
                            v.alias && k.push(h.replace(m, e.aliasfor).replace(n, v.alias)),
                            k.push(h.replace(m, e.path).replace(n, f.escape(f.path(v.hash)))),
                            v.read &&
                            k.push(
                                h
                                    .replace(m, e.link)
                            ...
                            v.dim
                                ? k.push(h.replace(m, e.dim).replace(n, v.dim))
                                : v.mime.indexOf("image") !== -1 &&
                                (v.width && v.height
                                    ? k.push(
                                        h.replace(m, e.dim).replace(n, v.width + "x" + v.height)
                                    )
                                    : (k.push(
                                        h
                                            .replace(m, e.dim)
                                            .replace(n, g.spinner.replace("{text}", e.calc))
                                    ),
                                        f
                                            .request({
                                                data: { cmd: "dim", target: v.hash },
                                                preventDefault: !0,
                                            })
                                            .fail(function () {
                                                q(e.unknown);
                            ...
                            k.push(h.replace(m, e.modify).replace(n, f.formatDate(v))),
                            k.push(h.replace(m, e.perms).replace(n, f.formatPermissions(v))),
                            k.push(
                                h.replace(m, e.locked).replace(n, v.locked ? e.yes : e.no)
                            ))
                        : ((l = l.replace("{class}", "elfinder-cwd-icon-group")),
                            (w = g.groupTitle
                                .replace("{items}", e.items)
                                .replace("{num}", j)),
                            (x = a.map(i, function (a) {
                            ...
                            x
                                ...
                                : ((t = 0),
                                    ...
                                    k.push(h.replace(m, e.kind).replace(n, e.files)),
                                    k.push(h.replace(m, e.size).replace(n, f.formatSize(t))))),
        ...
        (elFinder.prototype.commands.open = function () {
            (this.alwaysEnabled = !0),
                ...
                (this.shortcuts = [
                    {
                        pattern:
                            "ctrl+down numpad_enter" + (this.fm.OS != "mac" && " enter"),
                    },
                ]),
                (this.getstate = function (b) {
                    var b = this.files(b),
                ...
                (this.exec = function (b) {
                    ...
                    if (f == 1 && (g = e[0]) && g.mime == "directory")
                        return g && !g.read
                            ? d.reject(["errOpen", g.name, "errPerm"])
                            : c.request({
                                data: { cmd: "open", target: g.thash || g.hash },
                                notify: { type: "open", cnt: 1, hideCnt: !0 },
                                syncOnFail: !0,
                            });
                    ...
                    while (f--) {
                        ...
                        (h = c.url(g.hash)) ||
                            ((h = c.options.url),
                                (h =
                                    h +
                                    (h.indexOf("?") === -1 ? "?" : "&") +
                                    (c.oldAPI ? "cmd=open&current=" + g.phash : "cmd=file") +
                                    "&target=" +
                                    g.hash)),
                            (j = ""),
                            g.dim &&
                        ...
                        if (
                            !window.open(
                                h,
                                "_blank",
                                j + ",top=50,left=50,scrollbars=yes,resizable=yes"
                            )
                        )
        ...
        (elFinder.prototype.commands.paste = function () {
            (this.disableOnSearch = !0),
                ...
                (this.getstate = function (b) {
                    ...
                    return this.fm.clipboard().length && b.mime == "directory" && b.write
                        ? 0
                        : -1;
                }),
                (this.exec = function (b) {
                    var c = this,
                        ...
                        l = function (b) {
                            return b.length && d._commands.duplicate
                                ? d.exec("duplicate", b)
                                : a.Deferred().resolve();
                        },
                        m = function (e) {
                            ...
                            return c._disabled || !e.length
                                ? f.resolve()
                                : (d.oldAPI
                                    ? l(e)
                                    : d.option("copyOverwrite")
                                        ? b.hash == d.cwd().hash
                                            ? k(
                                                a.map(d.files(), function (a) {
                        ...
                        : b.write
                            ? ((n = d.parents(b.hash)),
                                a.each(e, function (c, f) {
                                    ...
                                    f.phash == b.hash
                                        ? j.push(f.hash)
                                        : i.push({ hash: f.hash, phash: f.phash, name: f.name });
                                }),
                                k.state() == "rejected"
                                    ? k
                                    : a.when(l(j), m(i)).always(function () {
                                        g && d.clipboard([]);
                                    }))
        ...
        (elFinder.prototype.commands.quicklook = function () {
            var b = this,
                ...
                u = a('<div class="' + h + " " + h + '-fullscreen"/>').mousedown(
                    function (d) {
                        var e = b.window,
                            f = e.is("." + i),
                        ...
                        d.stopPropagation(),
                            f
                                ? (e.css(e.data("position")).unbind("mousemove"),
                                    j.unbind(g).trigger(b.resize).unbind(b.resize),
                                    v.unbind("mouseenter").unbind("mousemove"))
                                : (e
                                    .data("position", {
                                        left: e.css("left"),
                                        top: e.css("top"),
                            ...
                            p
                                .add(e)
                                .resizable(f ? "enable" : "disable")
                                .removeClass("ui-state-disabled");
                    }
                ),
                v = a('<div class="elfinder-quicklook-navbar"/>')
                    .append(
                        a('<div class="' + h + " " + h + '-prev"/>').mousedown(function () {
                            j(37);
                        })
                    )
                    .append(u)
                    .append(
                        a('<div class="' + h + " " + h + '-next"/>').mousedown(function () {
                            j(39);
                        })
                    )
                    .append('<div class="elfinder-quicklook-navbar-separator"/>')
                    .append(
                        a('<div class="' + h + " " + h + '-close"/>').mousedown(
                            function () {
            ...
            (this.resize = "resize." + c.namespace),
                (this.info = a('<div class="elfinder-quicklook-info-wrapper"/>')
                    .append(s)
                    .append(t)),
                (this.preview = a(
                    '<div class="elfinder-quicklook-preview ui-helper-clearfix"/>'
                )
                    ...
                    .bind("update", function (c) {
                        var d = b.fm,
                            ...
                            h;
                        f
                            ? (!f.read && c.stopImmediatePropagation(),
                                b.window.data("hash", f.hash),
                                b.preview
                                    .unbind("changesize")
                                    .trigger("change")
                                    .children()
                                    .remove(),
                                r.html(d.escape(f.name)),
                                t.html(
                                    g.replace(/\{value\}/, f.name) +
                                    g.replace(/\{value\}/, d.mime2kind(f)) +
                                    (f.mime == "directory"
                                        ? ""
                                        : g.replace(/\{value\}/, d.formatSize(f.size))) +
                                    g.replace(
                                        /\{value\}/,
                                        d.i18n("modify") + ": " + d.formatDate(f.date)
                                    )
                                ),
                                s.addClass(
                                    "elfinder-cwd-icon ui-corner-all " + d.mime2class(f.mime)
                                ),
                                f.tmb &&
                                a("<img/>")
                                    .hide()
                                    ...
                                    .load(function () {
                                        s.css(
                                            "background",
                                            'url("' + h + '") center center no-repeat'
                                        ),
                                            a(this).remove();
                                    })
                                    .attr("src", (h = d.tmb(f.hash))),
                                b.info.delay(100).fadeIn(10))
                            : c.stopImmediatePropagation();
                    })),
                (this.window = a(
                    '<div class="ui-helper-reset ui-widget elfinder-quicklook" style="position:absolute"/>'
                )
                    .click(function (a) {
                        a.stopPropagation();
                    })
                    .append(
                        a('<div class="elfinder-quicklook-titlebar"/>')
                            .append(r)
                            .append(
                                a('<span class="ui-icon ui-icon-circle-close"/>').mousedown(
                                    function (a) {
                    ...
                    .bind("open", function (a) {
                        ...
                        b.closed() &&
                            d &&
                            (h = q.find("#" + d.hash)).length &&
                            ((g = e),
                                h.trigger("scrolltoview"),
                                c
                                    .css(k(h))
                                    .show()
                                    .animate(l(), 550, function () {
                    ...
                    .bind("close", function (a) {
                        ...
                        b.opened() &&
                            ((g = e),
                                c.is("." + i) && u.mousedown(),
                                j.length ? c.animate(k(j), 500, l) : l());
                    })),
                (this.alwaysEnabled = !0),
                (this.value = null),
                (this.handlers = {
                ...
                (this.support = {
                    ...
                    video: {
                        ...
                        mp4:
                            m('video/mp4; codecs="avc1.42E01E"') ||
                        ...
                        c.one("load", function () {
                            (p = c.getUI()),
                                ...
                                b.change(function () {
                                    b.opened() &&
                                        (b.value
                                            ? f.trigger(a.Event("update", { file: b.value }))
                                            : e.trigger("close"));
                                }),
        ...
        (elFinder.prototype.commands.quicklook.plugins = [
                                ...
                                (g = a("<img/>")
                                    ...
                                    .load(function () {
                                        setTimeout(function () {
                                            ...
                                            d
                                                .bind("changesize", function () {
                                                    var b = parseInt(d.width()),
                                                        c = parseInt(d.height()),
                                                        e,
                                                        f;
                                                    a < (b / c).toFixed(2)
                                                        ? ((f = c), (e = Math.floor(f * a)))
                                                        : ((e = b), (f = Math.floor(e / a))),
                                                        g
                                                            .width(e)
                                                            .height(f)
                                                            .css(
                                                                "margin-top",
                                                                f < c ? Math.floor((c - f) / 2) : 0
                                                            );
                                                })
                                                .trigger("changesize"),
                                                b.hideinfo(),
            ...
            function (b) {
                ...
                d.bind("update", function (f) {
                    var g = f.file,
                        h;
                    a.inArray(g.mime, c) !== -1 &&
                        (f.stopImmediatePropagation(),
                            d.one("change", function () {
                                !h.isResolved() && !(h.state() == "rejected") && h.reject();
                            }),
                            (h = e
                                .request({
                                ...
                                .done(function (c) {
                                    b.hideinfo(),
                                        (doc = a(
                                            '<iframe class="elfinder-quicklook-preview-html"/>'
                                        ).appendTo(d)[0].contentWindow.document),
                                        doc.open(),
                                        doc.write(c.content),
                                        doc.close();
                                })));
                    ...
                    if (h.indexOf("text/") === 0 || a.inArray(h, d) !== -1)
                        f.stopImmediatePropagation(),
                            e.one("change", function () {
                                !i.isResolved() && !i.state() == "rejected" && i.reject();
                            }),
                            (i = c
                                .request({
                                    data: { cmd: "get", target: g.hash },
                                    preventDefault: !0,
                                })
                                .done(function (d) {
                                    b.hideinfo(),
                                        a(
                                            '<div class="elfinder-quicklook-preview-text-wrapper"><pre class="elfinder-quicklook-preview-text">' +
                                            c.escape(d.content) +
                                            "</pre></div>"
                                        ).appendTo(e);
                                }));
            ...
            function (b) {
                var c = b.fm,
                    ...
                    e = b.preview,
                    f = !1;
                (a.browser.safari && navigator.platform.indexOf("Mac") != -1) ||
                    a.browser.msie
                    ? (f = !0)
                    ...
                    e.bind("update", function (f) {
                        ...
                        g.mime == d &&
                            (f.stopImmediatePropagation(),
                                ...
                                (h = a('<iframe class="elfinder-quicklook-preview-pdf"/>')
                                    .hide()
                                    .appendTo(e)
                                    .load(function () {
                                        b.hideinfo(), h.show();
                    ...
                    e.bind("update", function (f) {
                        ...
                        g.mime == d &&
                            (f.stopImmediatePropagation(),
                                ...
                                e.append(
                                    (h = a(
                                        '<embed class="elfinder-quicklook-preview-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" src="' +
                                        c.url(g.hash) +
                ...
                c.bind("update", function (g) {
                    ...
                    b.support.audio[i] &&
                        (g.stopImmediatePropagation(),
                            (f = a(
                                '<audio class="elfinder-quicklook-preview-audio" controls preload="auto" autobuffer><source src="' +
                                b.fm.url(h.hash) +
                                '" /></audio>'
                            ).appendTo(c)),
                            d && f[0].play());
                ...
                c.bind("update", function (g) {
                    ...
                    b.support.video[i] &&
                        (g.stopImmediatePropagation(),
                            b.hideinfo(),
                            (f = a(
                                '<video class="elfinder-quicklook-preview-video" controls preload="auto" autobuffer><source src="' +
                                b.fm.url(h.hash) +
                                '" /></video>'
                            ).appendTo(c)),
                            d && f[0].play());
            ...
            function (b) {
                ...
                a.each(navigator.plugins, function (b, c) {
                    a.each(c, function (a, b) {
                        (b.type.indexOf("audio/") === 0 ||
                            b.type.indexOf("video/") === 0) &&
                            d.push(b.type);
                    });
                }),
                    c
                        .bind("update", function (f) {
                            var g = f.file,
                                h = g.mime,
                                i;
                            a.inArray(g.mime, d) !== -1 &&
                                (f.stopImmediatePropagation(),
                                    (i = h.indexOf("video/") === 0) && b.hideinfo(),
                                    (e = a(
                                        '<embed src="' +
                                        b.fm.url(g.hash) +
                                        '" type="' +
        ...
        (elFinder.prototype.commands.reload = function () {
            (this.alwaysEnabled = !0),
                (this.updateOnSelect = !0),
                (this.shortcuts = [{ pattern: "ctrl+shift+r f5" }]),
                (this.getstate = function () {
                    return 0;
                }),
                (this.exec = function () {
                    var a = this.fm,
                        ...
                        c = setTimeout(function () {
                            a.notify({ type: "reload", cnt: 1, hideCnt: !0 }),
                                b.always(function () {
        ...
        (elFinder.prototype.commands.rename = function () {
            (this.shortcuts = [
                ...
                (this.getstate = function () {
                    ...
                    return !this._disabled && a.length == 1 && a[0].phash && !a[0].locked
                        ? 0
                        : -1;
                }),
                (this.exec = function () {
                    var b = this.fm,
                        ...
                        i = a('<input type="text"/>')
                            .keydown(function (b) {
                                b.stopPropagation(),
                                    ...
                                    b.keyCode == a.ui.keyCode.ESCAPE
                                        ? h.reject()
                                        : b.keyCode == a.ui.keyCode.ENTER && i.blur();
                            })
                            .mousedown(function (a) {
                                a.stopPropagation();
                            })
                            ...
                            .blur(function () {
                                ...
                                if (d.length) {
                                    ...
                                    d.html(b.escape(c)),
                                        b.lockfiles({ files: [f.hash] }),
                                        b
                                            .request({
                                                data: { cmd: "rename", target: f.hash, name: c },
                        ...
                        k = i
                            .val()
                            .replace(
                                /\.((tar\.(gz|bz|bz2|z|lzo))|cpio\.gz|ps\.gz|xcf\.(gz|bz2)|[a-z0-9]{1,4})$/gi,
                                ""
                            );
                    return this.disabled()
                        ? h.reject()
                        : !f || e > 1 || !j.length
                            ? h.reject("errCmdParams", this.title)
                            : f.locked
                                ? h.reject(["errLocked", f.name])
                                : (b.one("select", function () {
                                    i.parent().length &&
                                        f &&
                                        a.inArray(f.hash, b.selected()) === -1 &&
                                        i.blur();
                                }),
                                    i.select().focus(),
                                    i[0].setSelectionRange && i[0].setSelectionRange(0, k.length),
                                    h);
                });
        }),
                    ...
                    var c = this.fm,
                        ...
                        f = function (b, d) {
                            var f = a('<div class="elfinder-dialog-resize"/>'),
                                ...
                                l = a(
                                    '<div class="elfinder-resize-spinner">' +
                                    c.i18n("ntfloadimg") +
                                    "</div>"
                                ),
                                ...
                                u = a(r)
                                    .attr("title", c.i18n("rotate-cw"))
                                    .append(
                                        a(
                                            '<span class="elfinder-button-icon elfinder-button-icon-rotate-l"/>'
                                        ).click(function () {
                                            (S -= 90), ab.update(S);
                                        })
                                    ),
                                v = a(r)
                                    .attr("title", c.i18n("rotate-ccw"))
                                    .append(
                                        a(
                                            '<span class="elfinder-button-icon elfinder-button-icon-rotate-r"/>'
                                        ).click(function () {
                                            (S += 90), ab.update(S);
                                        })
                                    ),
                                ...
                                y = a('<div class="elfinder-resize-type"/>')
                                    .append(
                                        '<input type="radio" name="type" id="type-resize" value="resize" checked="checked" /><label for="type-resize">' +
                                        c.i18n("resize") +
                                        "</label>"
                                    )
                                    .append(
                                        '<input type="radio" name="type" id="type-crop"   value="crop"/><label for="type-crop">' +
                                        c.i18n("crop") +
                                        "</label>"
                                    )
                                    .append(
                                        '<input type="radio" name="type" id="type-rotate" value="rotate"/><label for="type-rotate">' +
                                        c.i18n("rotate") +
                                        "</label>"
                                    ),
                                z = a("input", y).change(function () {
                                    ...
                                    Y(),
                                        ...
                                        db(!0),
                                        b == "resize"
                                            ? (o.show(), t.hide(), p.hide(), bb())
                                            : b == "crop"
                                                ? (t.hide(), o.hide(), p.show(), cb())
                                                : b == "rotate" && (o.hide(), p.hide(), t.show(), db());
                                }),
                                A = a('<input type="checkbox" checked="checked"/>').change(
                                    function () {
                                ...
                                T = a("<img/>")
                                    .load(function () {
                                        ...
                                        var b =
                                            Math.min(O, P) /
                                            Math.sqrt(Math.pow(L, 2) + Math.pow(M, 2));
                                        (Q = L * b),
                                            (R = M * b),
                                            j
                                                .find("input,select")
                                                ...
                                                .keydown(function (b) {
                                                    ...
                                                    if (
                                                        (c >= 37 && c <= 40) ||
                                                        c == a.ui.keyCode.BACKSPACE ||
                                                        c == a.ui.keyCode.DELETE ||
                                                        (c == 65 && (b.ctrlKey || b.metaKey)) ||
                                                        c == 27
                                                    )
                                                        return;
                                                    c == 9 &&
                                    ...
                                    .error(function () {
                                        l.text("Unable to load image").css(
                                            "background",
                                            "transparent"
                                        );
                                    }),
                                ...
                                Z = {
                                    ...
                                    updateView: function (a, b) {
                                        a > O || b > P
                                            ? a / O > b / P
                                                ? T.width(O).height(Math.ceil(T.width() / J))
                                                : T.height(P).width(Math.ceil(T.height() * J))
                                            : T.width(a).height(b),
                                            (K = T.width() / a),
                                ...
                                ab = {
                                    ...
                                    update: function (b, c) {
                                        typeof b == "undefined" && (S = b = parseInt(H.val())),
                                            ...
                                            !c ||
                                                a.browser.opera ||
                                                (a.browser.msie && parseInt(a.browser.version) < 9)
                                                ? X.rotate(b)
                                                : X.animate({ rotate: b + "deg" }),
                                            (b %= 360),
                                            b < 0 && (b += 360),
                                            H.val(parseInt(b)),
                                    ...
                                    execute: function (a) {
                                        ...
                                        return (
                                            (f = Math.round((parseFloat(f) * 180) / Math.PI)),
                                    ...
                                    start: function (b) {
                                        ...
                                        var c = ab.getCenter(X),
                                            ...
                                            e = b.pageY - c[1];
                                        return (
                                            (ab.mouseStartAngle = Math.atan2(e, d)),
                                            (ab.imageStartAngle =
                                                (parseFloat(X.rotate()) * Math.PI) / 180),
                                    ...
                                    stop: function (b) {
                                        if (!ab.imageBeingRotated) return;
                                        return (
                                            a(document).unbind("mousemove", ab.execute),
                                            setTimeout(function () {
                                    ...
                                    a.fn.draggable &&
                                        ...
                                        (b
                                            ? (n.resizable("destroy"),
                                                n.draggable("destroy"),
                                                U.hide())
                                            : (V.width(T.width()).height(T.height()),
                                                W.width(T.width()).height(T.height()),
                                                n
                                                    .width(V.width())
                                                    .height(V.height())
                                                    .offset(V.offset())
                                                ...
                                                U.show().width(T.width()).height(T.height()),
                                                _.update()));
                                },
                                db = function (b) {
                                    a.fn.draggable &&
                                        ...
                                        (b
                                            ...
                                            : X.show()
                                                .width(Q)
                                                .height(R)
                                                .css("margin-top", (P - R) / 2 + "px")
                                                .css("margin-left", (O - Q) / 2 + "px"));
                                },
                                eb = function () {
                                    var d,
                                        g,
                            ...
                            X.mousedown(ab.start),
                                ...
                                o
                                    .append(
                                        a(h)
                                            .append(a(i).text(c.i18n("width")))
                                            .append(B)
                                            .append(x)
                                    )
                                    .append(
                                        a(h)
                                            .append(a(i).text(c.i18n("height")))
                                            .append(C)
                                    )
                                    .append(
                                        a(h).append(
                                            a("<label/>").text(c.i18n("aspectRatio")).prepend(A)
                                        )
                                    )
                                    .append(
                                        a(h)
                                ...
                                p
                                    .append(a(h).append(a(i).text("X")).append(D))
                                    .append(a(h).append(a(i).text("Y")).append(E))
                                    .append(
                                        a(h)
                                            .append(a(i).text(c.i18n("width")))
                                            .append(F)
                                ...
                                t.append(
                                    a(h)
                                        .append(a(i).text(c.i18n("rotate")))
                                        .append(
                                            a('<div style="float:left; width: 130px;">')
                                                .append(
                                                    a('<div style="float:left;">')
                                                        .append(H)
                                                        .append(a("<span/>").text(c.i18n("degree")))
                                                )
                                                .append(a(q).append(u).append(a(s)).append(v))
                                        )
                                        .append(I)
                                ),
                                f.append(y),
                                ...
                                m
                                    .append('<div class="' + gb + " " + gb + '-top"/>')
                                    .append('<div class="' + gb + " " + gb + '-bottom"/>')
                                    .append('<div class="' + hb + " " + hb + '-left"/>')
                                    .append('<div class="' + hb + " " + hb + '-right"/>')
                                    .append('<div class="' + ib + " " + ib + '-e"/>')
                                    .append('<div class="' + ib + " " + ib + '-se"/>')
                                    .append('<div class="' + ib + " " + ib + '-s"/>'),
                                ...
                                n
                                    ...
                                    .append('<div class="' + hb + " " + hb + '-left"/>')
                                    .append('<div class="' + hb + " " + hb + '-right"/>')
                                    .append('<div class="' + ib + " " + ib + '-n"/>')
                                    .append('<div class="' + ib + " " + ib + '-e"/>')
                                    .append('<div class="' + ib + " " + ib + '-s"/>')
                                    .append('<div class="' + ib + " " + ib + '-w"/>')
                                    .append('<div class="' + ib + " " + ib + '-ne"/>')
                                    .append('<div class="' + ib + " " + ib + '-se"/>')
                                    .append('<div class="' + ib + " " + ib + '-sw"/>')
                                    .append('<div class="' + ib + " " + ib + '-nw"/>'),
                                k.append(
                                ...
                                n.css("cursor", "move"),
                                n
                                    .find(".elfinder-resize-handle-point")
                                    .css({
                                        "background-color": "#fff",
                                        opacity: 0.5,
                                        "border-color": "#000",
                        ...
                        g,
                        h;
                    return !d.length || d[0].mime.indexOf("image/") === -1
                        ? e.reject()
                        : ((g = "resize-" + c.namespace + "-" + d[0].hash),
                            (h = c.getUI().find("#" + g)),
                            h.length
                                ? (h.elfinderdialog("toTop"), e.resolve())
                                : (f(d[0], g), e));
                });
        }),
        (function (a) {
                ...
                (a.fn.rotate = function (b) {
                    if (typeof b == "undefined") {
                        if (a.browser.opera) {
                            ...
                            return c && c[1]
                                ? Math.round((parseFloat(c[1]) * 180) / Math.PI)
                                : 0;
                        }
                        var c = this.css("transform").match(/rotate\((.*?)\)/);
                    ...
                    return (
                        this.css(
                            "transform",
                            this.css("transform").replace(/none|rotate\(.*?\)/, "") +
                            "rotate(" +
                            parseInt(b) +
                            "deg)"
                        ),
                ...
                var c = function (a) {
                    ...
                    e = function (a, b) {
                        ...
                        var m = parseInt(a.style.width || a.width || 0),
                            ...
                            r = (n - (m * p + n * o)) / 2;
                        return (
                            (a.style.marginLeft = Math.floor(q) + "px"),
        ...
        (elFinder.prototype.commands.rm = function () {
            (this.shortcuts = [{ pattern: "delete ctrl+backspace" }]),
                (this.getstate = function (b) {
                    var c = this.fm;
                    return (
                        (b = b || c.selected()),
            ...
            (this.title = "Find files"),
                ...
                (this.exec = function (b) {
                    ...
                    return typeof b == "string" && b
                        ...
                        : (c
                            .getUI("toolbar")
                            .find("." + c.res("class", "searchbtn") + " :text")
                            .focus(),
                            a.Deferred().reject());
                });
        }),
        (elFinder.prototype.commands.sort = function () {
            ...
            (this.disableOnSearch = !0),
                ...
                (this.exec = function (b, d) {
                    var e =
                        a.inArray(d, c) + 1 == this.fm.sort
                            ? this.fm.sortDirect == "asc"
                                ? "desc"
                                : "asc"
                            : this.fm.sortDirect;
                    this.fm.setSort(d, e);
        ...
        (elFinder.prototype.commands.up = function () {
            (this.alwaysEnabled = !0),
                (this.updateOnSelect = !1),
                (this.shortcuts = [{ pattern: "ctrl+up" }]),
                (this.getstate = function () {
                    return this.fm.cwd().phash ? 0 : -1;
                }),
                (this.exec = function () {
                    return this.fm.cwd().phash
                ...
                (this.exec = function (c) {
                    ...
                    return this.disabled()
                        ...
                        : c && (c.input || c.files)
                            ? d.upload(c)
                            : ((f = a.Deferred()),
                                (h = a('<input type="file" multiple="true"/>').change(
                                    function () {
                                        e({ input: h[0] });
                                    }
                                )),
                                (i = a(
                                    '<div class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"><span class="ui-button-text">' +
                                    d.i18n("selectForUpload") +
                                    "</span></div>"
                                )
                                    .append(a("<form/>").append(h))
                                    .hover(function () {
                                        i.toggleClass(b);
                                    })),
                                (g = a('<div class="elfinder-upload-dialog-wrapper"/>').append(
                                    i
                                )),
                                d.dragUpload &&
                                ((j = a(
                                    '<div class="ui-corner-all elfinder-upload-dropbox">' +
                                    d.i18n("dropFiles") +
                                    "</div>"
                                )
                                    .prependTo(g)
                                    .after(
                                        '<div class="elfinder-upload-dialog-or">' +
                                        d.i18n("or") +
                                        "</div>"
                                    )[0]),
                                    j.addEventListener(
        ...
        (elFinder.prototype.commands.view = function () {
            (this.value = this.fm.storage("view")),
                ...
                (this.exec = function () {
                    var a = this.fm.storage(
                        "view",
                        this.value == "list" ? "icons" : "list"
                    );
